...
import { PingSlashCommand,testSlashCommand, urlSlashCommand } from './commands/ping'
...
// Register commands
const commandList: Array<SlashCommand> = [PingSlashCommand,testSlashCommand, urlSlashCommand]
